...
class Batch_Loader(object):
	def __init__(self, train_triples, n_entities, batch_size=100, neg_ratio = 0.0, contiguous_sampling = False,lambda_svm = 1):
...
class TransE_Batch_Loader(Batch_Loader):
	...
	def __init__(self, model, train_triples, n_entities, batch_size=100, neg_ratio = 0.0, contiguous_sampling = False, lambda_svm = 1):
		super(TransE_Batch_Loader, self).__init__(train_triples, n_entities, batch_size, neg_ratio, contiguous_sampling,lambda_svm)

...
if __name__ =="__main__":
	...
	params = Parameters(learning_rate = 0.1, 
						max_iter = 1000, 
						batch_size = int(len(fb15kexp.train.values) / 10),  #Make 100 batches
						neg_ratio = 1, 
						valid_scores_every = 1000,
						learning_rate_policy = 'adagrad',
						contiguous_sampling = False )

	all_params = { "wTransE_1L_Model" : params } ; emb_size = 200; lmbda =5;params.miuA = 0.5;params.miuB = 0.5;params.lambda_A =0.001;params.lambda_B=0.004

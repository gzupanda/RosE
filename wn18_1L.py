...
if __name__ =="__main__":
	...
	params = Parameters(learning_rate = 0.05, 
						max_iter = 1000,
	...
	all_params = { "wTransE_1L_Model" : params } ; emb_size = 300; lmbda = 3; params.miuA = 1;params.miuB = 0.5;params.lambda_A =0.01;params.lambda_B=0.04
